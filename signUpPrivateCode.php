...
try
{
	...
	if ($email == "" || $password == "" || $fName == "" || $lName == "" || count_chars($password) < 8 || count_chars($email) < 10 || count_chars($fName) < 2 || count_chars($lName) < 2)
	{
		die("First and last name must be at least 2 characters, password must be at least 8 characters, and email must be at least 10 characters.");
	}
