...
<body>
	<h2>Business Account</h2><h1>Sign Up</h1>
	
	<form id="centered" action="signUpBusinessCode.php" method="POST">
		...
		<input class="textBox" type="text" name="bName" placeholder="Busness Name" maxlength="40"> <br><br><br>
