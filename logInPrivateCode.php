...
try
{
	...
	{
		die("One or more of the requirements was not fulfilled!");
	}
	...
	if ($email == "" || $password == "" || count_chars($password) < 8 || count_chars($email) < 10)
	{
	...
	{
		die("This email doesn't exist! Try to sign up instead");
	}
	...
	{
		die("<h1>The password is incorrect!</h1>");
	}
}
catch(Exception $e)
{
